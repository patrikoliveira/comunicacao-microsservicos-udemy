...
import br.com.comunicacaomicrosservicosudemy.productapi.modules.sales.dto.SalesProductResponse;
...
import static br.com.comunicacaomicrosservicosudemy.productapi.config.RequestUtil.getCurrentRequest;
...
public class ProductService {
    ...
    private void validateStockUpdateData(ProductStockDTO product) {
        if (isEmpty(product) || isEmpty(product.getSalesId())) {
            throw new ValidationException("The product data and the sales ID cannot be null.");
        }
